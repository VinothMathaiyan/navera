    ...
    <main className="ad">
      ...
      <div className="ad-wrap">
        ...
        <section className="ad-forecast">
          ...
          {/* Two shopping numbers, equal weight — STILL TO MAKE only, which
              since 2026-08-20 means confirmed AND preparing: a batch being
              made has not been made yet. Anything dispatched or delivered is
              out, because counting a finished batch told Gowri to buy the same
              milk twice. Whole litres, because the shop does not sell 0.2 of
              one. Both the filter and the rounding come from computeForecast,
              which the production tab reads too — the two screens cannot
              answer differently. */}
          ...
          <div className="ad-fc-foot">
            ...
            {forecast.doneCount > 0 && (
              <>
                {" "}
                · {forecast.doneCount} already dispatched or delivered, not counted
